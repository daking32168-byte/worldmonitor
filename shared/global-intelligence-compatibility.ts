...
export const LEGACY_MARKET_STATUS_TO_V2: Record<LegacyMarketProviderStatus, DataDisplayStatus> = {
  ...
  PROVIDER_STATUS_DELAYED_15M: 'OBSERVED',
  PROVIDER_STATUS_DELAYED_UNVERIFIED: 'DELAYED_UNVERIFIED',
  PROVIDER_STATUS_END_OF_DAY: 'OBSERVED',
  PROVIDER_STATUS_HISTORICAL_SNAPSHOT: 'OBSERVED',
  ...
  PROVIDER_STATUS_MARKET_CLOSED: 'OBSERVED',
};
